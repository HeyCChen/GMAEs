...
def pretrain(model, pooler, dataloaders, batch_list, idx_list, optimizer, max_epoch, device, scheduler, num_classes, lr_f, weight_decay_f, max_epoch_f, linear_prob=True, logger=None):
...
def main(args):
    ...
    for i, seed in enumerate(seeds):
        ...
        if not load_model:
            model = pretrain(model, pooler, (train_loader, eval_loader), batch_list, idx_list, optimizer, max_epoch, device,
