...
def build_args():
    ...
    parser.add_argument("--trans_num_layers", type=int, default=1,
                        help="number of transforemr layers")
    parser.add_argument("--enc_type", type=str,
                        default="normal", help="normal,parallel,group,mixed")
    parser.add_argument("--dec_type", type=str,
                        default="gnn", help="gnn,mlp,gt,ct")
    parser.add_argument("--num_subgraph", type=int, default=0,
                        help="number of subgraph")
    parser.add_argument("--dec_num_layers", type=int, default=1,
                        help="number of decoder layers")
    parser.add_argument("--subgraph_lambda", type=int, default=2,
                        help="parameters of subgraph")
    parser.add_argument("--pe_dim", type=int, default=32,
                        help="dimension of position embedding")
    parser.add_argument('--kd_num_layer', type=int, default=12,
                        help='layer nums of kd (default:12), 4,8,12')
    parser.add_argument('--kd_alpha', type=float, default=1.0,
                        help='parameter of kd loss (default: 10.0).')
